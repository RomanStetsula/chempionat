  ...
  <div class="col-md-4">
    <div class="text-center">
      ...
      <form action="{{ route('unisharp.lfm.getCrop') }}" role='form' name='cropForm' id='cropForm' mathod='post'>
        <input type="dhidden" id="img" name="img" value="{{ $img }}">
        <input type="dhidden" id="working_dir" name="working_dir" value="{{ $working_dir }}">
        <input type="dhidden" id="dataX" name="dataX">
        <input type="dhidden" id="dataY" name="dataY">
        <input type="dhidden" id="dataWidth" name="dataWidth">
        <input type="dhidden" id="dataHeight" name="dataHeight">
        <input type='dhidden' name='_token' value='{{csrf_token()}}'>
      </form>
    </div>
  </div>
