...
<div class="">
  ...
  <div class = "errors">
    ...
    <div class="col-xs-12">
      <div class="col-xs-3">
       @if (isset($leagve->id))
         {{ Form::model($leagve, ['route'=>['admin-leagves.update', $leagve->id], 'method'=>'PUT']) }}
       @else
         {{ Form::open(['url' => 'leagues']) }}
       @endif
       <div class="form-group">
       {{ Form::label('leagve_name', 'Назва ліги', ['class' => 'control-label']) }}
       {{ Form::text('leagve_name', old('leagvename'), ['class'=>"form-control"]) }}
       </div>
      </div>
      <div class="col-xs-3">
       <div class="form-group">
    ...
    <div class="col-xs-12">
      ...
      <div class="col-xs-3">
       <div class="form-group leagve-checkbox">
