...
<div class="edit-team"> 
  ...
  {{  HTML::ul($errors->all()) }}
    ...
    <div class = "editteam-form">
      {{ Form::open(['url' => 'admin-teams', 'files' => true, 'id'=>'form', 'enctype'=>'multipart/form-data']) }}
    </div>
    ...
    <div class ="col-xs-12">
      <div class ="col-xs-6">  
        ...
        <div class="added-logo">
            <img src='' alt='Logotype' id="img-preview-logo">
            <br />
      ...
      <div class ="col-xs-6">
        ...
        <div class="added-foto">
            <img src='' alt='Logotype' id="img-preview-foto">
            <br />
